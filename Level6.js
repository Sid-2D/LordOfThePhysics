...
LoTP.lv6.prototype = {
    ...
    preload: function() {
        ...
        this.back = this.add.sprite(this.world.centerX,this.world.centerY,'back6');
        ...
        this.help = this.add.sprite(60,621,'fH');
        ...
        this.ban = this.add.sprite(550,720-660,'ban6');
    ...
    addGround : function() {        
        ...
        fixtureDef.restitution = 0.2;             
        fixtureDef.shape = new Box2D.Collision.Shapes.b2PolygonShape();
        fixtureDef.shape.SetAsBox(0.5*390/worldScale,0.03);
        fixtureDef.filter.groupIndex=-1;
        
        var bodyDef = new Box2D.Dynamics.b2BodyDef;
        bodyDef.type = Box2D.Dynamics.b2Body.b2_staticBody;
        bodyDef.position.Set(195/worldScale,340/worldScale);
        ...
        fixtureDef.restitution = 0.2;             
        fixtureDef.shape = new Box2D.Collision.Shapes.b2PolygonShape();
        fixtureDef.shape.SetAsBox(0.03,0.5*5/worldScale);
        fixtureDef.filter.groupIndex=-1;
        
        bodyDef = new Box2D.Dynamics.b2BodyDef;
        bodyDef.type = Box2D.Dynamics.b2Body.b2_staticBody;
        bodyDef.position.Set(390/worldScale,((520-390)/2+390)/worldScale);
        ...
        fixtureDef.restitution = 0.2;             
        fixtureDef.shape = new Box2D.Collision.Shapes.b2PolygonShape();
        fixtureDef.shape.SetAsBox(0.5*(1280-390)/worldScale,0.03);
        fixtureDef.filter.groupIndex=-1;
        
        bodyDef = new Box2D.Dynamics.b2BodyDef;
        bodyDef.type = Box2D.Dynamics.b2Body.b2_staticBody;
        bodyDef.position.Set((0.5*(1280-390)+390)/worldScale,520/worldScale);
    ...
    update: function() {
        if(!over) {
            ...
            // Game Over!
            if(bodyList[1].GetUserData().asset.x+100>=1060 && bodyList[1].GetUserData().asset.y-100 < 270 && bodyList[1].GetLinearVelocity().x < 1e-12 && bodyList[1].GetLinearVelocity().x > 0)
            {    
                over = true;
