...
LoTP.lv8.prototype = {
    ...
    preload: function() {
        ...
        this.fr = this.add.sprite(-320,622.5,'fS');
        ...
        this.over = this.add.sprite(this.world.centerX,this.world.centerY,'p2');
