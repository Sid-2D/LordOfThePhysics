...
LoTP.lv7.prototype = {
    ...
    preload: function() {
        ...
        this.back = this.add.sprite(this.world.centerX,this.world.centerY,'back7');
        ...
        this.help = this.add.sprite(58,619,'l7fH');
        ...
        this.gxH = this.add.sprite(15,61.5,'l7gxH');
        this.gxH.anchor.setTo(0.5,0.5);
        
        this.gxT = this.add.sprite(140,61.5,'gX');
        this.gxT.anchor.setTo(0.5,0.5);  
        
        this.ban = this.add.sprite(740,50,'ban7');
        this.ban.anchor.setTo(0.5,0.5);
        this.ban.scale.x = this.ban.scale.y = 0.7;
        this.addBody(740,50,0.7*230,0.7*69);
        
        this.ball = this.add.sprite(120,20,'gball');
        this.ball.anchor.setTo(0.5,0.5);
        this.addBall(120,20,156);
        
        this.av = this.add.sprite(1042,375,'avButtonP');
        this.av.anchor.setTo(0.5,0.5);
        this.av.alpha  = 0;
        this.av.inputEnabled = true;
        this.av.events.onInputDown.add(this.bDown,this);
        this.av.events.onInputUp.add(this.bUp,this);
        ...
        this.over = this.add.sprite(this.world.centerX,this.world.centerY,'avo');
        this.over.anchor.setTo(0.5,0.5);
        this.add.tween(this.over).to( { alpha: 0 }, 5000, Phaser.Easing.Linear.None, true);
    },
    ...
    addGround : function() {        
        ...
        fixtureDef.restitution = 0.2;             
        fixtureDef.shape = new Box2D.Collision.Shapes.b2PolygonShape();
        fixtureDef.shape.SetAsBox(0.5*380/worldScale,0.03);
        fixtureDef.filter.groupIndex=-1;
        
        var bodyDef = new Box2D.Dynamics.b2BodyDef;
        bodyDef.type = Box2D.Dynamics.b2Body.b2_staticBody;
        bodyDef.position.Set(190/worldScale,520/worldScale);
        ...
        fixtureDef.restitution = 0.2;             
        fixtureDef.shape = new Box2D.Collision.Shapes.b2PolygonShape();
        fixtureDef.shape.SetAsBox(593/worldScale,0.03);
        fixtureDef.filter.groupIndex=-1;
        
        bodyDef = new Box2D.Dynamics.b2BodyDef;
        bodyDef.type = Box2D.Dynamics.b2Body.b2_staticBody;
        bodyDef.position.Set(380/worldScale,520/worldScale);
        
        body = boxWorld.CreateBody(bodyDef);
        body.CreateFixture(fixtureDef);
        body.SetAngle(-0.56897);
        ...
        fixtureDef.restitution = 0.2;             
        fixtureDef.shape = new Box2D.Collision.Shapes.b2PolygonShape();
        fixtureDef.shape.SetAsBox(0.5*407/worldScale,0.03);
        fixtureDef.filter.groupIndex=-1;
        
        bodyDef = new Box2D.Dynamics.b2BodyDef;
        bodyDef.type = Box2D.Dynamics.b2Body.b2_staticBody;
        bodyDef.position.Set(1089/worldScale,196/worldScale);
    ...
    update: function() {
        if(!over) {
            ...
            // Game Over!
            if(bodyList[1].GetUserData().asset.x+100>=1060)
            {    
                over = true;
