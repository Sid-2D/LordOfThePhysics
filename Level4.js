...
LoTP.lv4.prototype = {
    ...
    preload: function() {
        ...
        this.back = this.add.sprite(this.world.centerX,this.world.centerY,'back4');
        ...
        this.gxH = this.add.sprite(15,62,'l4gxH');
        this.gxH.anchor.setTo(0.5,0.5);
        
        this.gxT = this.add.sprite(140,61.5,'gX');
        this.gxT.anchor.setTo(0.5,0.5);
        
        this.gY = this.add.sprite(130,134,'smS');
        this.gY.anchor.setTo(0.5,0.5);
        this.gY.inputEnabled = true;
        this.gY.input.enableDrag(false,false,false,255,new Phaser.Rectangle(-115,101,357,66));
        this.gY.events.onDragUpdate.add(this.gyUpdate,this);
        
        this.gyH = this.add.sprite(15,132,'l4gyH');
        this.gyH.anchor.setTo(0.5,0.5);
        
        this.gyT = this.add.sprite(140,131.5,'gY');
        this.gyT.anchor.setTo(0.5,0.5);
        
        this.ban = this.add.sprite(1000,720-660,'ban4');
        this.ban.anchor.setTo(0.5,0.5);
        this.ban.scale.x = this.ban.scale.y = 0.7;
        this.addBody(1000,720-660,0.7*230,0.7*69,this.ban,'ban');
        ...
        this.gravHelp = this.add.sprite(this.world.centerX,this.world.centerY,'gravHelp');
        this.gravHelp.anchor.setTo(0.5,0.5);
        
        this.add.tween(this.gravHelp).to( { alpha: 0 }, 5000, Phaser.Easing.Linear.None, true);
    ...
    addGround : function() {        
        ...
        bodyDef.position.Set(640/worldScale,556/worldScale);
        ...
        fixtureDef.restitution = 0.2;             
        fixtureDef.shape = new Box2D.Collision.Shapes.b2PolygonShape();
        fixtureDef.shape.SetAsBox(0.5*25/worldScale,0.5*155/worldScale);
        fixtureDef.filter.groupIndex=-1;
        
        bodyDef = new Box2D.Dynamics.b2BodyDef;
        bodyDef.type = Box2D.Dynamics.b2Body.b2_staticBody;
        bodyDef.position.Set(651/worldScale,355/worldScale);
