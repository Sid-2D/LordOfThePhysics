...
LoTP.lv10.prototype = {
    ...
    preload: function() {
        bodyList = [];
        over = false;
        gr1 = new Box2D.Common.Math.b2Vec2(0,10);
        this.gr2 = new Box2D.Common.Math.b2Vec2(0,0);
        boxWorld = new Box2D.Dynamics.b2World(new Box2D.Common.Math.b2Vec2(0,2),false);
        this.addGround();
        ...
        this.back = this.add.sprite(this.world.centerX,this.world.centerY,'back10');
        ...
        this.rest = this.add.sprite(235,45,'smS');
        ...
        this.gX = this.add.sprite(75,45,'smS');
        ...
        this.ban = this.add.sprite(850,60,'ban10');
        this.ban.anchor.setTo(0.5,0.5);
        this.ban.scale.x = this.ban.scale.y = 0.7; 
        this.addBody(850,60,0.7*230,0.7*69);
        
        this.ball = this.add.sprite(600,20,'bball');
        this.ball.anchor.setTo(0.5,0.5);
        this.addBall(600,20,156);
    ...
    update: function() {
        if(!over) {
            ...
            if(once && this.ball.y >= 300) {
                boxWorld.SetGravity(this.gr2);
                bodyList[1].ApplyTorque(100);
                bodyList[1].SetLinearVelocity(this.gr2);
                setTimeout( function() {
                    once = false;
                    bodyList[1].ApplyTorque(-100);
                    bodyList[1].SetAngularVelocity(100);
                    boxWorld.SetGravity(gr1);
                },2000); 
            }
            ...
            {       
                ...
                if(bodyList[1].GetLinearVelocity().x < 1e-12 && bodyList[1].GetLinearVelocity().x > 0 && bodyList[1].GetAngularVelocity() < 1e-6) 
                {
                    over = true;
